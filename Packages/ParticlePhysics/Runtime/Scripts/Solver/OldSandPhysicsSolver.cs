...
{
    public class OldSandPhysicsSolver
    {
        // Simulation
        ...
        private Utils.NearestNeighbour.GridSearch<ParticleState> _nearestNeighbor;

        public GraphicsBuffer _debugger;

        public OldSandPhysicsSolver(
            ...
            int terrainResolution, Vector3 terrainRatio, float terrainFriction)
        {
            ...
            _nearestNeighbor = new Utils.NearestNeighbour.GridSearch<ParticleState>(_particleNum, gridSize, gridCellSize)
            {
        ...
        public void SetParticleCSParams(ParticleBuffer particle)
        {
